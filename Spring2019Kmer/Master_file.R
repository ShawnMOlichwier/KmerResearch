...
library(data.table)
training <- read.csv('/Users/group13/Downloads/kmer_6_12/train_sequences_6mer_stride1_tokens.csv.count.csv',header = TRUE)
...
testing = read.csv("/Users/group13/Downloads/kmer_6_12/test_sequences_6mer_stride1_tokens.csv.count.csv", header = TRUE)
...
print(cm08)
saveRDS(logreg.fit01, "/Users/group13/Downloads/kmer_6_12/LogReg01_6mer.rds")
saveRDS(logreg.fit05, "/Users/group13/Downloads/kmer_6_12/LogReg05_6mer.rds")
saveRDS(logreg.fit08, "/Users/group13/Downloads/kmer_6_12/LogReg08_6mer.rds")
############################################################################
